...
export class Game extends Node {
    ...
    onClickCard(evt) {
        ...
        if (this.countClick === 0 && card.isFlip === false && this._loading === false) {
            this.countClick++;
        ...
        else if (this.countClick === 1 && card.isFlip === false && this._loading === false) {
            this.countClick++;
    ...
    _initAudio(){
        ...
        startAudio.setAttribute("controls", "none");
